...
if(likeurl==="./unfilled-heart.png"){
  ...
  return (
    <div>
        ...
        <div id="buttonBox" className='flex text-center justify-end'><a href={props.url} target='_blank' id='button'>Read More</a>
        
        <button id='likesButton' onClick={increaseLike}><img src={likeurl} alt="" /></button></div>
        </div>
    </div>
  )
}
